...
#define MIN_TURN_US 1000
#define MAX_TURN_US 1850
...
#define VEHICLE_LENGTH_MM 500

#define DISTANCE_BETWEEN_WHEELS_MM 250
...
// Motor PID
const double proportional_throttle = .5 //.0175;
const double integral_throttle = .2;
const double derivative_throttle = .05 //.00001;

// Steering PID
const double proportional_steering = .0175;
const double integral_steering = .5;
const double derivative_steering = .05 //.00001;
